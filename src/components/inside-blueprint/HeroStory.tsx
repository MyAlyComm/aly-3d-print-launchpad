...
export const HeroStory = () => {
  return <section className="relative py-20 overflow-hidden bg-gradient-to-b from-primary/5 to-white">
      <div className="container px-4 mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1">
            <img src="/lovable-uploads/d1a2c586-5f86-4edf-865e-d27b19a65ec9.png" alt="Aly with her 3D printing setup" className="rounded-lg shadow-2xl transform hover:scale-105 transition-transform duration-300" />
          </div>
        </div>
      </div>
    </section>;
