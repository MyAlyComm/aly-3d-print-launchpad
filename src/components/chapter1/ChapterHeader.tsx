  ...
  return (
    <Card className="mb-6 bg-gradient-to-r from-purple-50 to-blue-50 overflow-hidden">
      ...
      <CardContent className="pt-6 relative z-10">
        <h1 className="text-3xl font-bold mb-2 text-gray-800">Arbitrage Windows</h1>
        ...
        <div className="flex items-center mt-4 gap-2">
          <div className="flex -space-x-2">
            {[1, 2, 3].map((i) => (
              <div key={i} className={`h-10 w-10 rounded-full border-2 border-white flex items-center justify-center text-xs font-medium bg-gradient-to-r from-indigo-${i*100} to-purple-${i*100}`}>
                {i}
              </div>
            ))}
          </div>
